...
BOARD_KERNEL_CMDLINE := androidboot.boot_devices=mstar_mci.0 buildvariant=user
...
TARGET_KERNEL_CONFIG := mt5867_defconfig
TARGET_KERNEL_SOURCE := kernel/mediatek/mt5867
